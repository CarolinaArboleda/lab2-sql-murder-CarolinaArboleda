...
Este es el laboratorio 2 del curso de estructuras de datos y laboratorio. Laboratorio de SQL para resolver el desafío SQL Murder Mystery y documentar la investigación con consultas y evidencias en GitHub.
